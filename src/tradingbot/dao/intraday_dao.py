...
from typing import List, Tuple, Any, Final, Union
...
from tradingbot.common.constants import US_EASTERN, REQUEST_SLEEP
...
class IntradayDAO(BaseDAO):
    ...
    @classmethod
    def create_symbol(cls, symbol: str) -> None:
        try:
    ...
    @classmethod
    def create_symbol_extended(cls, symbol: str) -> None:
    ...
    @classmethod
    def create_from_file(cls, content: str) -> None:
